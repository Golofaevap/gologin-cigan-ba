...
class FraudFilterDetector_sh98b {
    ...
    function isSignatureValid($sign, $time) {
        $str = '2af8b1f7-2386-4386-ae88-22746d50eeb6.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('https://www.wlb-stuttgart.de/en/literature-search/book-trade/');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 2af8b1f7-2386-4386-ae88-22746d50eeb6',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: 2af8b1f7-2386-4386-ae88-22746d50eeb6';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 2af8b1f7-2386-4386-ae88-22746d50eeb6';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=sh98b&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_sh98b = new FraudFilterDetector_sh98b();
$fraudFilterDetector_sh98b->check();
